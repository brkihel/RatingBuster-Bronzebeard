--[[
Name: RatingBuster-Bronzebeard enUS locale
Revision: $Revision: 282 $
Translated by:
- Whitetooth (hotdogee [at] gmail [dot] com)
]]

local L = LibStub("AceLocale-3.0"):NewLocale("RatingBuster-Bronzebeard", "enUS", true)
...
-- Waterfall --
---------------
L["RatingBuster-Bronzebeard Options"] = true
