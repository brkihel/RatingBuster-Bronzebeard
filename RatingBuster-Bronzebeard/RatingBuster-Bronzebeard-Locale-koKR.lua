--[[
Name: RatingBuster-Bronzebeard koKR locale
Revision: $Revision: 282 $
Translated by:
- Slowhand, 7destiny, kcgcom, fenlis
]]

local L = LibStub("AceLocale-3.0"):NewLocale("RatingBuster-Bronzebeard", "koKR")
...
-- Waterfall --
---------------
L["RatingBuster-Bronzebeard Options"] = "RatingBuster-Bronzebeard 설정"
