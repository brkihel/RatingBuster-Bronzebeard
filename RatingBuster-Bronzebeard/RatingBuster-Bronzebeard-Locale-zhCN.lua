--[[
Name: RatingBuster-Bronzebeard zhCN locale
...
local L = LibStub("AceLocale-3.0"):NewLocale("RatingBuster-Bronzebeard", "zhCN")
...
-- Waterfall --
---------------
L["RatingBuster-Bronzebeard Options"] = "RatingBuster-Bronzebeard选项"
