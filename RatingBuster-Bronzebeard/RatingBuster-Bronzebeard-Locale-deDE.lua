--[[
Name: RatingBuster-Bronzebeard deDE locale
Revision: $Revision: 282 $
Translated by:
- Kuja
]]

local L = LibStub("AceLocale-3.0"):NewLocale("RatingBuster-Bronzebeard", "deDE")
...
-- Waterfall --
---------------
L["RatingBuster-Bronzebeard Options"] = "RatingBuster-Bronzebeard Optionen"
