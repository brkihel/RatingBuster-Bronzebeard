--[[
Name: RatingBuster-Bronzebeard esES locale
...
local L = LibStub("AceLocale-3.0"):NewLocale("RatingBuster-Bronzebeard", "esES")
...
-- Waterfall --
---------------
L["RatingBuster-Bronzebeard Options"] = "Opciones RatingBuster-Bronzebeard"
...
local MX = LibStub("AceLocale-3.0"):NewLocale("RatingBuster-Bronzebeard", "esMX")
