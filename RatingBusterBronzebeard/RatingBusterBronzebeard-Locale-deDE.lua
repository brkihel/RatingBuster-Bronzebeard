--[[
Name: RatingBusterBronzebeard deDE locale
Revision: $Revision: 282 $
Translated by:
- Kuja
]]

local L = LibStub("AceLocale-3.0"):NewLocale("RatingBusterBronzebeard", "deDE")
...
-- Waterfall --
---------------
L["RatingBusterBronzebeard Options"] = "RatingBusterBronzebeard Optionen"
