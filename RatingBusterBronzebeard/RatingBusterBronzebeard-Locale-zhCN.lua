--[[
Name: RatingBusterBronzebeard zhCN locale
...
local L = LibStub("AceLocale-3.0"):NewLocale("RatingBusterBronzebeard", "zhCN")
...
-- Waterfall --
---------------
L["RatingBusterBronzebeard Options"] = "RatingBusterBronzebeard选项"
