--[[
Name: RatingBusterBronzebeard esES locale
...
local L = LibStub("AceLocale-3.0"):NewLocale("RatingBusterBronzebeard", "esES")
...
-- Waterfall --
---------------
L["RatingBusterBronzebeard Options"] = "Opciones RatingBusterBronzebeard"
...
local MX = LibStub("AceLocale-3.0"):NewLocale("RatingBusterBronzebeard", "esMX")
